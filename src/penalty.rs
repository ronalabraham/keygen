...
static BASE_PENALTY: KeyMap<f64> = KeyMap([
	4.0, 3.0, 1.0, 1.0, 1.5, 3.0,    3.0, 1.5, 1.0, 1.0, 3.0, 4.0,
	2.0, 0.5, 0.5, 0.0, 0.0, 1.5,    1.5, 0.0, 0.0, 0.5, 0.5, 2.0,
	4.0, 2.0, 2.0, 1.5, 1.5, 2.5,    2.5, 1.5, 1.5, 2.0, 2.0, 4.0,
	     20.0, 2.5, 1.5, 0.0, 1.5,    1.5, 0.0, 1.5, 2.5, 20.0,
						1.5, 3.0,	 3.0, 1.5]);
